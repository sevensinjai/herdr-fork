...
pub(crate) fn resolve_non_indexed_action(
    ...
    for (bindings, action) in [
        ...
        (&keybinds.sidecar_toggle, KeybindAction::SidecarToggle),
        (
            &keybinds.sidecar_switch_tab,
            KeybindAction::SidecarSwitchTab,
        ),
        (
            &keybinds.sidecar_send_selection,
            KeybindAction::SidecarSendSelection,
        ),
